...
const slides = [
  { image: "/images/V3/web/front-three-quarter.webp", eyebrow: "Unica Venere", title: <>La forma italiana.<br/><em>Senza compromessi.</em></>, link: "/venere/" },
  { image: "/images/V3/web/front-light.webp", eyebrow: "Design · Ingegneria · Materia", title: <>Un’icona, vista<br/><em>con occhi nuovi.</em></>, link: "/venere/#design" },
  { image: "/images/V3/web/front-logo.webp", eyebrow: "Carrozzeria contemporanea", title: <>Automobili costruite<br/><em>attorno a te.</em></>, link: "/atelier/" },
];
...
export default function HomeExperience() {
  ...
  return <>
    ...
    <section className="collection-section" data-reveal><div className="collection-head"><p className="section-tag light">/ La collezione</p><h2>Due anime.<br/><em>Una firma.</em></h2></div><div className="collection-grid">
      <Link className="collection-card" href="/venere/"><img src={asset("/images/V3/web/side.webp")} alt="Venere"/><div className="collection-shade"/><div className="collection-meta"><span>01 · Grand Tourer</span><img src={asset("/images/venere-wordmark.png")} alt="Venere"/><p>V8 aspirato · Cambio manuale</p><i>Esplora il modello ↗</i></div></Link>
    ...
    <section className="craft-teaser" data-reveal><img src={asset("/images/V3/web/front-logo.webp")} alt="Il cofano della Venere V3 in officina"/><div className="craft-shade"/><div className="craft-copy"><p className="section-tag light">/ Porte aperte</p><h2>Dove l’idea<br/>diventa <em>materia.</em></h2><p>Il cliente non osserva il progetto da lontano: entra nell’atelier, incontra chi costruisce la sua automobile e può seguirne ogni passaggio.</p><Link href="/atelier/">Vivi l’atelier ↗</Link></div></section>
  </>;
}
